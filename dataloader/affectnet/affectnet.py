...
class AffectNet(Dataset):
    ...
    def _pre_operate(self, root):  # occlusion_affectnet/, pose30_affectnet/, pose45_affectnet/
        image_file = os.path.join(root, 'affectnet_info/images.txt')
        split_file = os.path.join(root, 'affectnet_info/train_test_split.txt')
        class_file = os.path.join(root, 'affectnet_info/image_class_labels.txt')
